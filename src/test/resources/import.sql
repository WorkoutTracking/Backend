INSERT INTO useraccount (id, created_at, name, email) VALUES ('473cc7ef-f4a8-4325-bda5-a4847938313c', CURRENT_TIMESTAMP, 'admin', 'admin@gmail.com');

INSERT INTO workout (id, created_at, user_email, name) VALUES ('32b5646c-cecb-4518-ae17-bcd296990db7', CURRENT_TIMESTAMP, 'admin@gmail.com', 'Push');
INSERT INTO workout (id, created_at, user_email, name) VALUES ('d0e244ce-bd2f-4a30-b467-f3930f37e4dc', CURRENT_TIMESTAMP, 'admin@gmail.com', 'Pull');
